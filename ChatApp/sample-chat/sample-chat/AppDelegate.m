...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    //
    [QBSettings setApplicationID:11001];
    [QBSettings setAuthorizationKey:@"45veGEaZMM3Cq6C"];
    [QBSettings setAuthorizationSecret:@"qAwxUwyQmV9eueS"];
    [QBSettings setAccountKey:@"fyUyuFzMc1E5Uo1Sgmjh"];
